                    ...
                    <div className="grid sm:grid-cols-[2fr_1fr] gap-4">
                        <div>
                            ...
                            <div className="flex space-x-10 text-lg">
                                <div>{items.bedroom} Bed</div>
                                <div>{items.bathroom} Bath</div>
                                <div>{items.size} SqFT</div>
                            </div>
                            ...
                            <div className="overflow-hidden overflow-x-auto border border-gray-100 rounded">
                                <table className="min-w-full text-base divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td className="p-4 text-gray-700 whitespace-nowrap">{items.listedBy}</td>
                                    </tr>

                                    <tr>
                                        <td className="p-4 font-medium whitespace-nowrap">Property Reference</td>
                                        <td className="p-4 text-gray-700 whitespace-nowrap">{items.propertyRef}</td>
                                    </tr>
                        ...
                        <div>
                            <div className="p-10 border border-gray-200 grid rounded-lg">
                                ...
                                <p className="text-sm">RERA Registration No : {items.propertyInfo}</p>
