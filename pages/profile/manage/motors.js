...
export default function ManageMotors() {
 ...
 const deleteHandler = async (productId, productImages) => {
  ...
  return (
      <>
        <Header></Header>
        <div className='max-w-screen-xl w-screen mx-auto md:py-4 px-8 md:my-4 rounded-lg shadow' data-aos="zoom-y-out">
            ...
            <div className="grid lg:grid-cols-[1fr_1fr_4fr] gap-4">
                ...
                <div className="overflow-scroll lg:overflow-auto">
                  <ul className="inline-flex lg:block whitespace-nowrap lg:ml-0 text-base space-y-0 md:space-y-4">
                          ...
                          <Link href={'/profile/manage/motors'}><li className="py-2 px-4 rounded-lg text-white active">{t('motors')}</li></Link>
