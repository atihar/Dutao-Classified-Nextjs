 ...
 const deleteHandler = async (productId, productImages) => {
  ...
  return (
      <>
        ...
        <div className='sm:max-w-screen-xl sm:w-screen mx-auto py-4 px-8 my-4 rounded-lg shadow' data-aos="zoom-y-out">
            ...
            <div className="grid lg:grid-cols-[1fr_1fr_4fr] gap-4">
                ...
                <div>
                  <ul className="ml-10 lg:ml-0 text-base space-y-4">
                          <Link href={'/profile/manage/property-for-sale'}><li className="py-2 px-4 rounded-lg text-white active">{t('propertyForSale')}</li></Link>
                    ...
                    <div className="py-4 px-6 w-full">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash-fill" viewBox="0 0 16 16">
                          ...
                          <button onClick={showpopupHandler} className='pl-2'>Delete</button></p>
                          { popUp && 
