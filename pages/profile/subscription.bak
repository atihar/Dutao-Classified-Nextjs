            ...
            <div className="grid sm:grid-cols-[1fr_3fr] gap-4">
                ...
                <div>
                    <div className="py-5 w-full bg-gray-100 mt-4 rounded-lg p-5">
                        ...
                        <section className="sm:max-w-screen-xl mx-auto sm:p-8" id="purchaseCard">
                            <div className="block sm:w-screen sm:max-w-sm p-5 sm:p-10 border sm:px-12 bg-white rounded-2xl"
                            ...
                            <h1 className="text-2xl sm:text-6xl font-bold">0 dhs</h1>
                                <div className="ml-4">
                        ...
                        <section className="sm:max-w-screen-xl mx-auto p-4 sm:p-8" id="purchaseCard">
                        <div
                        className="block sm:w-screen sm:max-w-sm p-6 sm:p-10 border sm:px-12 bg-gray-900 text-gray-100 rounded-2xl"
                        ...
                        <div className="flex pt-8 pb-6 items-end">
                        <h1 className="text-2xl sm:text-6xl font-bold">50 dhs</h1>
                            <div className="ml-4">
                            <h3 className="text-sm">user/year</h3>
                            </div>
                        </div>
