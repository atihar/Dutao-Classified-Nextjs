...
export default function PrivacyPolicy() {
  return (
    <>
    <Header/>
    <section className='max-w-screen-xl mx-auto my-5 px-3 sm:my-10 text-base'>
    ...
    <br/>
    <h1 className='font-bold'>Interpretation and Definitions</h1>
    ...
    <li>
    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Dutao, 3101, Westburry Business Tower, Business Bay, Dubai.</p>
    </li>
    <li>
    ...
    <li>
    <p><strong>Website</strong> refers to Dutao, accessible from <a href="https://dutao.ae" rel="external nofollow noopener" target="_blank">https://dutao.ae</a></p>
    </li>
    <li>
    ...
    <ul>
    <li>
    <p>By email: contact@dutao.ae</p>
    </li>
    <li>
    <p>By visiting this page on our website: <a href="https://dutao.ae/contact" rel="external nofollow noopener" target="_blank">https://dutao.ae/contact</a></p>
    </li>
    </ul>
    </section>
    <Footer/>
