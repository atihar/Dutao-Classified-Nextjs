...
export default function Home(props) {
  ...
  return (
    ...
    <section>
          ...
          <Filter></Filter>
            <p className='text-sm text-gray-500 py-3'>Total {props.countProducts} motor items found</p>
          <div className='grid grid-cols-[3fr_1fr] gap-4'>
            <div className=''>
                {products && products.map((motor) => (
                <div className=" flex justify-center' py-2" key={motor._id} >
                  ...
                  src={"https://dutao.s3.me-south-1.amazonaws.com/"+ motor.images[0]} alt="" />
                    ...
                    <div className="py-4 px-6 w-full">
                      ...
                      <p className="mb-1 text-lg font-bold text-red-600">AED {motor.price}</p>

                      <p className="text-gray-400 py-1 text-xs">Last updated 3 mins ago</p>

                      <p className="mb-2 text-sm pt-1 text-gray-500">{motor.marketYear} Built Year - {motor.kilometers} mileage</p>
