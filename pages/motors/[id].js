                        ...
                        <div>
                            ...
                            <div className="grid">       
                                {motor.images.map((x, i)=>{
                                    return <img className=" md:h-auto object-cover md:w-[96] rounded-t-lg md:rounded-l-lg" key={i} src={`https://dutao-public.s3.amazonaws.com/` + x } alt="" />
                                })}
                            </div>
                            ...
                            <div className="overflow-hidden overflow-x-auto border border-gray-100 rounded">
                                <table className="min-w-full text-base divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td className="p-4 text-gray-700 whitespace-nowrap">fresh</td>
                                    </tr>
