            ...
            <section>
                <div className="max-w-screen-xl p-5 mx-auto sm:px-6 lg:px-8">
                    <div className="grid sm:grid-cols-[2fr_1fr] gap-4">
                        <div>
                            <h1>{motor.title}</h1>
                            <p className="text-sm text-gray-500 mb-3">Dubai { ` > `} {motor.area}</p>
                           
                            <div className="grid">       
                                {motor.images.map((x, i)=>{
                                    return <img className=" md:h-auto object-cover md:w-[96] rounded-t-lg md:rounded-l-lg" key={i} src={"https://dutao.s3.me-south-1.amazonaws.com/" + x } alt="" />
                                })}
                            </div>
...
`                                            <path d="M11 6.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1zm-3 0a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1zm-5 3a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1zm3 0a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1z"/>
                            ...
                            <p className="mt-5">About this motor</p>
                            ...
                            <div className="overflow-hidden overflow-x-auto border border-gray-100 rounded">
                                <table className="min-w-full text-base divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        <td className="p-4 font-medium whitespace-nowrap">Body Condition</td>
                                        <td className="p-4 text-gray-700 whitespace-nowrap">No</td>
                                    </tr>

                                    <tr>
                                        <td className="p-4 font-medium whitespace-nowrap">Mechanical Condition</td>
                                        <td className="p-4 py-2 text-gray-700 whitespace-nowrap">Sale</td>
                                    </tr>

                                    <tr>
                                        <td className="p-4 font-medium whitespace-nowrap">Body Type</td>
                                        <td className="p-4 text-gray-700 whitespace-nowrap">{motor.listedBy}</td>
                                    </tr>

                                    <tr>
                                        <td className="p-4 font-medium whitespace-nowrap">Number of cylinders</td>
                                        <td className="p-4 text-gray-700 whitespace-nowrap">{motor.cylinders}</td>
                                    </tr>

                                    <tr>
                                        <td className="p-4 font-medium whitespace-nowrap">Transmission Type</td>
                                        <td className="p-4 text-gray-700 whitespace-nowrap">{motor.transmissionType}</td>
                                    </tr>
                                    <tr>
                                        <td className="p-4 font-medium whitespace-nowrap">Regional Specs</td>
                                        <td className="p-4 text-gray-700 whitespace-nowrap">{motor.regionalSpec}</td>
                                    </tr>
                                    <tr>
                                        <td className="p-4 font-medium whitespace-nowrap">Engine Horsepower</td>
                                        <td className="p-4 text-gray-700 whitespace-nowrap">{motor.horsePower}</td>
                                    </tr>
                                    <tr>
                                        <td className="p-4 font-medium whitespace-nowrap">Fuel Type</td>
                                        <td className="p-4 text-gray-700 whitespace-nowrap">{motor.fuelType}</td>
                                    </tr>
                                    <tr>
                                        <td className="p-4 font-medium whitespace-nowrap">Steering Side</td>
                        ...
                        <div>
                            <div className="p-10 border border-gray-200 grid rounded-lg">
                                ...
                                <p className="text-sm">RERA Registration No : 32323</p>
