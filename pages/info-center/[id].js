                    ...
                    <div className="grid sm:grid-cols-[2fr_1fr] gap-4">
                        ...
                        <div>
                            <div className="p-10 border bg-red-50 border-gray-200 grid rounded-lg">
                                ...
                                <p className="text-sm">{t('phNo')} : 05 xxxxx </p>
                                {/* <p className="text-sm pb-5">DED license no : 213234</p> */}

                                    <a className="inline-block space-x-2 text-center px-12 py-3 text-sm font-medium text-white bg-red-600 border border-red-600 rounded active:text-red-500 hover:bg-transparent hover:text-red-600 focus:outline-none focus:ring" 
                                    href={`tel:${item.phone}`}>
