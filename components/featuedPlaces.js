            ...
            <div className="flex flex-wrap w-1/2">
              <div className="w-1/2 p-1 md:p-2 relative">
                <img alt="gallery" className="block object-cover object-center w-full h-full rounded-lg"
                  ...
                  <div className="opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 flex justify-center items-center text-6xl text-white font-semibold">Marina</div>
              </div>
              <div className="w-1/2 p-1 md:p-2 relative">
                <img alt="gallery" className="block object-cover object-center w-full h-full rounded-lg"
              ...
              <div className="w-full p-1 md:p-2 relative">
                <img alt="gallery" className="block object-cover object-center w-full h-full rounded-lg"
                  src="https://www.timeoutdubai.com/cloud/timeoutdubai/2021/09/10/fCsshvnp-JW-Marriott-Marquis-Business-Bay.jpg"/>
                                    <div className="opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 flex justify-center items-center text-6xl text-white font-semibold">Business Bay</div>
              </div>
            </div>
            <div className="flex flex-wrap w-1/2">
              <div className="w-full p-1 md:p-2 relative">
                <img alt="gallery" className="block object-cover object-center w-full h-full rounded-lg"
                  ...
                  <div className="opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 flex justify-center items-center text-6xl text-white font-semibold">Downtown</div>
              </div>
              <div className="w-1/2 p-1 md:p-2 relative">
                <img alt="gallery" className="block object-cover object-center w-full h-full rounded-lg"
                  src="https://imagevars.gulfnews.com/2020/12/07/Jumeirah-Lake-Towers--JLT-_1763c6bebb7_large.jpg"/>
                  <div className="opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 flex justify-center items-center text-6xl text-white font-semibold"> JLT </div>
              </div>
              <div className="w-1/2 p-1 md:p-2 relative">
                <img alt="gallery" className="block object-cover object-center w-full h-full rounded-lg"
                ...
                <div className="opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 flex justify-center items-center text-6xl text-white font-semibold">Int. City</div>
              </div>
            </div>
          </div>
        </div>
