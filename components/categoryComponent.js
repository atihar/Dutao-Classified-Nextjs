          ...
          <div className="max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div className=" max-w-screen-lg px-4 py-16 sm:px-6 lg:px-8 m-auto">
                ...
                <div className="z-10 grid grid-cols-3 gap-4 sm:grid-cols-3">
                    ...
                    <a className="block p-4 border text-center border-gray-100 shadow-sm rounded-xl focus:outline-none focus:ring hover:border-gray-200 hover:ring-1 hover:ring-gray-200"
                    >
                      <span className="inline-block p-3 rounded-lg bg-gray-50">
                      ...
                      <h6 className="mt-2 text-center text-sm font-bold"> 
                      {t('propertySale')} 
                      </h6>
                    </a></Link>
