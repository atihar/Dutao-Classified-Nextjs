          ...
          <div className="max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div className=" max-w-screen-lg px-4 py-16 sm:px-6 lg:px-8 m-auto">
                ...
                <div className="z-10 grid grid-cols-3 gap-4 sm:grid-cols-3">
                    ...
                    <a className="block p-2 border text-center border-gray-100 shadow-sm rounded-xl focus:outline-none focus:ring hover:border-gray-200 hover:ring-1 hover:ring-gray-200">
                    <span className="inline-block p-3 rounded-lg bg-gray-50 text-red-500 hover:text-black">
                    ...
                    <h6 className="mt-2 text-center text-xs md:text-sm font-bold"> {t('propertyRent')} </h6>
                    </a></Link>
                    ...
                    >
                      ...
                      <h6 className="mt-2 text-center text-xs md:text-sm font-bold"> 
                      {t('propertySale')} 
                      </h6>
                    </a></Link>
                    ...
                    <a  className="block p-2 border text-center border-gray-100 shadow-sm rounded-xl focus:outline-none focus:ring hover:border-gray-200 hover:ring-1 hover:ring-gray-200"
                      >
                      <span className="inline-block p-3 rounded-lg bg-gray-50 text-red-500 hover:text-black">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-inboxes-fill" viewBox="0 0 16 16">
                    ...
                    <Link href={'/jobs'}>
                    <a
                    className="block p-2 border text-center border-gray-100 shadow-sm rounded-xl focus:outline-none focus:ring hover:border-gray-200 hover:ring-1 hover:ring-gray-200">
                    <span className="inline-block p-3 rounded-lg bg-gray-50 text-red-500 hover:text-black">
